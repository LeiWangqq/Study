        ...
        for elem in root:
            ...
            for subelem in elem:
                ...
                if bndbox['xmin'] is not None:
                    ...
                    addAnnoItem(object_name, current_image_id, current_category_id, bbox)
    # json.dump(coco, open(json_save_path, 'w'))
    with open(json_save_path, 'w') as output_json_file:
        json_str = json.dumps(coco, indent=1, sort_keys=True, ensure_ascii=False)
...
if __name__ == '__main__':
    ...
    # 通过文件夹生成
    ann_path = r"H:\daochu_classfied\3channel_tif_voc\Annotations"
    json_save_path = r"H:\daochu_classfied\3channel_tif_voc\copy.json"
